				...
				<div class="row">
                    ...
                    <div class="clearfix centered-content">
                        <div class="right-part col-sm-7">
                            ...
                            <p>Le bouton en haut à droite renvoie à la table des matières et permet de naviguer à l’intérieur de l’œuvre.</p>
                        </div>
                        <div class="left-part col-sm-5">
                            <img src="img/tutoriel/icone_tm.jpg" />
                        </div>
                    </div>
                    ...
                    <div class="clearfix centered-content">
                        <div class="right-part col-sm-7">
                            <h4>O/P</h4>
                            <p>Deux boutons, <strong>O</strong> et <strong>P</strong>, apparaissent dans la marge gauche des œuvres ayant connu un grand nombre de variations d’orthographe et de ponctuation. Ils permettent de neutraliser les différences de ces deux ordres.</p>
                        </div>
                        <div class="left-part col-sm-5">
                            <img src="img/tutoriel/icone_op.jpg" />
                        </div>
                    </div>
                    <p>
