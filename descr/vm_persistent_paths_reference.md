...
- Purpose:
  - Laravel `storage/` tree, including:
    ...
    - `storage/app/private/db_backups`
    - `storage/app/private/exports`
    - `storage/app/private/facsimile_backups`
    - `storage/app/private/facsimile_queue`
    - `storage/app/private/admin_maintenance_state.json`
    - `storage/app/private/admin_maintenance_announcement.json`
...
- Host path:
  - `/var/www/variance-input/var/laravel_storage/app/private/db_backups/...`
- Used by:
  - daily compressed SQL dumps generated by `php artisan backup:database`

### Admin maintenance state

- Host paths:
  - `/var/www/variance-input/var/laravel_storage/app/private/admin_maintenance_state.json`
  - `/var/www/variance-input/var/laravel_storage/app/private/admin_maintenance_announcement.json`
- Used by:
  - admin maintenance splash state
  - planned maintenance announcement state
