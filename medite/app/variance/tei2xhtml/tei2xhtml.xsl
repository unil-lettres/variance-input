...
<xsl:stylesheet exclude-result-prefixes="#all" version="3.0"
    ...
    <!-- 0 or 1 listTranspose -->
    <xsl:variable as="element(listTranspose)?" name="transposition"
                select="//listTranspose"/>

    <!-- 0 or 1 listAddition -->
    <xsl:variable as="element(listAddition)?"  name="addition"
                select="//listAddition"/>

    <!-- 0 or 1 listSubstitution -->
    <xsl:variable as="element(listSubstitution)?" name="substitution"
                select="//listSubstitution"/>

    <!-- 0 or 1 listDeletion -->
    <xsl:variable as="element(listDeletion)?"   name="deletion"
                select="//listDeletion"/>
