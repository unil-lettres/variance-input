...
class VersionController extends Controller
{
    ...
    {
        $requestedEncoding = $this->versionReaderService->normalizeSourceEncodingHint($request->query('encoding'));
    ...
    {
        $requestedEncoding = $this->versionReaderService->normalizeSourceEncodingHint($request->input('encoding', $request->query('encoding')));
