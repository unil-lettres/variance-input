...
Route::get('/versions/{version}/reader', [VersionController::class, 'readerData']);
Route::get('/versions/{version}/reader/page', [VersionController::class, 'readerPage']);
Route::post('/versions/{version}/text/convert-utf8', [VersionController::class, 'convertTextToUtf8']);
